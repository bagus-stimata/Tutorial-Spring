...
<vaadin-split-layout style="width: 100%; height: 100%;">
 <div style="flex-grow:1;width:100%;" id="wrapper">
  <vaadin-grid style="height:100%" theme="no-border" id="employees"></vaadin-grid>
 </div>
 <div style="width:400px;padding:var(--lumo-space-l)">
  <vaadin-form-layout>
   ...
   <vaadin-form-item>
    ...
    <vaadin-password-field class="full-width" id="password" style="flex-grow: 0; flex-shrink: 1;" placeholder="Password"></vaadin-password-field>
   </vaadin-form-item>
