...
public class MyAuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(Authentication authentication) {
        ...
        */
        logger.info("Cek User Name: determineTargetUrl: " + authentication.getName());
        ...
        if (isAdmin(roles)) {
            return "/"; //jika admin akan di redirect ke admin
            // return "/admin/index"; //jika admin akan di redirect ke admin
