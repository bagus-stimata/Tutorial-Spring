...
package com.example.springbootsecurity2withdb.rest_controller;

import com.example.springbootsecurity2withdb.model.Message;
...
public class HomeController {
	...
	// @RequestMapping(value = "/getmessage", method = RequestMethod.GET, produces =  = MediaType.APPLICATION_JSON)
